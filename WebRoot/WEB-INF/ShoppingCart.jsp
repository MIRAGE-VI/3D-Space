...
<script type="text/javascript" language="javascript">
	...
	function UpdateShoppingNum(Id,Num){				
		window.location.href="/3D-Space/shoppingCl.do?type=UpdateShoppingNum&GoodsId="+Id+"&UpdateShoppingNum="+Num;
	}
	
	function allSelect(){
		window.alert("allSelect");
...
<%-- <form class="form-signin" action = '/3D-Space/shoppingCl.do?type=CheckOutMyCart' method = 'post'>	--%>
...
<div class="am-tabs" data-am-tabs >
  <ul class="am-tabs-nav am-nav am-nav-tabs">
    <li class="am-active"><a href="#tab1"><h4>My Shopping Cart</h4></a></li>
  </ul>
  <div class="am-tabs-bd" style="background-color:#F3F3F3;">
    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
 	...
 	<table class="table table-hover">
        ...
        <tr>
            <td width="50%">
            <input type="checkbox" name="isAddToOrder<%=goods.getG_id()%>" value="<%=goods.getG_id()%>">
            ...
            <td style="vertical-align:middle;"><font size=3>x&nbsp</font>
            <input type="text" style="width:40px" value="<%=goods.getG_shoppingNum()%>" onchange="UpdateShoppingNum(<%=goods.getG_id()%>,this.value)"></td>
			...
			<a href="/3D-Space/shoppingCl.do?type=DeleteFromCart&GoodsId=<%=goods.getG_id()%>" class="btn btn-primary" type="button" data-toggle="tooltip" data-placement="bottom" title="Delete the Good"><span class="glyphicon glyphicon-trash" aria-hidden="true" ></span></a>
			</td>
        </tr>
        <% 
    		}
...
<div class="row" >
  <div class="col-sm-6 col-md-4" style="float:right; width:300px;">
    <div class="thumbnail">
     ...
     <input type="checkbox" name="allSelect"  onchange="allSelect()">
       <p align="right"><a href="/3D-Space/shoppingCl.do?type=CheckOutMyCart" class="btn btn-danger btn-lg" role="button">CheckOut</a> </p>
